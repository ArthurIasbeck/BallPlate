...
class Touch
{
    public:
        ...
        /**
         * @brief Retorna a posição do toque em centímetros no eixo X.
         * 
        ...
        /**
         * @brief Retorna a posição do toque em centímetros no eixo Y.
         * 
        ...
        /**
         * @brief Retorna a posição do toque em metros no eixo X.
         * 
         * @return Posição no eixo X.
         */
        float getX();
        ...
        /**
         * @brief Retorna a posição do toque em metros no eixo Y.
         * 
         * @return Posição no eixo Y.
         */
        float getY();
